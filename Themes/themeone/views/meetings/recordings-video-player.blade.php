...
<?php
	...
	$video_src = $content->recording;

	if($content->content_type=='file'){
        $video_src = VIDEO_PATH_UPLOAD_RECORDING.$content->recording;
...
@if($content->content_type=='url' || $content->content_type=='file' || $content->content_type=='audio')
