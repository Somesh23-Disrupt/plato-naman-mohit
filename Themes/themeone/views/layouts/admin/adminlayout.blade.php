...
<!-- 
					...
					<li {{ isActive($active_class, 'master') }} > 

					<a data-toggle="collapse" data-target="#master"><i class="fa fa-fw fa-desktop"></i> 
					{{ getPhrase('master') }} </a> 
					
					<ul id="master" class="collapse sidemenu-dropdown">
							<li><a href="{{URL_DEPARTMENT_LIST}}"> <i class="fa fa-fw fa-list"></i>{{ getPhrase('department') }}</a></li>
							<li><a href="{{URL_SECTION_LIST}}"> <i class="fa fa-fw fa-list"></i>{{ getPhrase('section') }}</a></li>
