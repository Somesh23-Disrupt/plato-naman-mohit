...
<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="panel panel-custom col-lg-8  col-lg-offset-2" >
					...
					<?php else: ?>
						<?php echo Form::open(array('url' => URL_EXAM_SERIES_ADD, 'method' => 'POST', 'files' => true, 'name'=>'formQuiz ', 'novalidate'=>'')); ?>

					<?php endif; ?>


					 <?php echo $__env->make('exams.examseries.form_elements',
					 array('button_name'=> $button_name),
					 array('record'=>$record, 'categories' => $categories,'sections'=> $sections,), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
