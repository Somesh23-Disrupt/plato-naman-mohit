					...
					<!-- <div class="col-md-3 col-sm-6">
				 	 ...
				 	 <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
								...
								<?php echo e(getPhrase('Total Pass percentage')); ?>
					 ...
					 <div class="col-md-3 col-sm-6">
						<div class="media state-media box-ws">
							...
							<div class="media-body">
								<h4 class="card-title"><?php echo e($tnps); ?></h4>
								<?php echo e(getPhrase('Total Pass Student')); ?>
				 	 ...
				 	 <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			<div class="media-left">
				 				<a href="<?php echo e(URL_TOPLIST); ?>"><div class="state-icn bg-icon-orange"><i class="fa fa-question-circle"></i></div></a>
				 			</div>
				 			<div class="media-body">
				 				<h4 class="card-title"><?php echo e($tnps); ?></h4>
								<a href="<?php echo e(URL_TOPLIST); ?>"><?php echo e(getPhrase('Top Students')); ?></a>
				 			</div>
				 		</div>
				 	</div>
					 <div class="col-md-3 col-sm-6">
				 		<div class="media state-media box-ws">
				 			...
				 			<div class="media-body">
				 				<h4 class="card-title"><?php echo e(round($avg,0)); ?></h4>
								<a href="<?php echo e(URL_TOPLIST); ?>"><?php echo e(getPhrase('Average score ')); ?></a>
				 			</div>
				 		</div>
				 	</div>
