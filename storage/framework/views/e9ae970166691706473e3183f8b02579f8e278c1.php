...
<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="panel panel-custom col-lg-6 col-lg-offset-3">
					...
					<?php endif; ?>
					<?php #dd($teachers); ?>
					 <?php echo $__env->make('mastersettings.subjects.form_elements',array('button_name'=> $button_name),array('sections'=> $sections,'teachers'=>$teachers), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
