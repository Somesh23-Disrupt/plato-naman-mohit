<div ng-if="question_type=='checkbox'">
    ...
    <fieldset class="form-group col-md-4" >
    <label > <?php echo e(getPhrase('image')); ?></label>
 ...
 <fieldset class="form-group" ng-if="total_answers > 0">
        <?php echo e(Form::label('total_correct_answers', getphrase('total_correct_answers'))); ?>

        <span class="text-red">*</span>
        <?php echo e(Form::select('total_correct_answers',$exam_max_options , null, ['class'=>'form-control', "id"=>"total_correct_answers", "ng-model"=>"total_correct_answers", "ng-change" => "correctAnswersChanged(total_correct_answers)",
        'required'=> 'true', 
