...
<div ng-if="question_type=='match'">
    ...
    <fieldset class="form-group ">
        <?php echo e(Form::label('total_answers', getphrase('total_options'))); ?>
    ...
    <div ng-if="total_answers > 0" class="row">
     ...
     <fieldset class="form-group col-md-5" >
        <label ><?php echo e(getPhrase('left_title')); ?></label> <span class="text-red">*</span>
     ...
     <fieldset class="form-group col-md-5" >
        <label ><?php echo e(getPhrase('right_title')); ?></label> <span class="text-red">*</span>
    ...
    <fieldset class="form-group col-md-5" >
        <label ><?php echo e(getPhrase('left_option')); ?> {{ $index+1 }}</label> <span class="text-red">*</span>
   ...
   <h4>For 2nd Language</h4>
     ...
     <fieldset class="form-group col-md-5" >
        ...
        <label ><?php echo e(getPhrase('left_title')); ?> (2nd Language) </label>
     ...
     <fieldset class="form-group col-md-5" >
        ...
        <label ><?php echo e(getPhrase('right_title')); ?> (2nd Language) </label>
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <label ><?php echo e(getPhrase('left_option')); ?> {{ $index+1 }} (2nd Language)</label>
