...
//Department in Master
Route::get('master/department/list', 'MasterController@index');
Route::get('master/department/getList', [ 'as'   => 'master.department.dataTable',
     'uses' => 'MasterController@getDatatable']);

Route::get('master/department/add', 'MasterController@create');
Route::post('master/department/add', 'MasterController@store');
Route::get('master/department/edit/{slug}', 'MasterController@edit');
Route::patch('master/department/edit/{slug}', 'MasterController@update');
Route::delete('master/department/delete/{slug}', 'MasterController@delete');
//Section in Master
Route::get('master/section/list', 'SectionController@index');
Route::get('master/section/getList', [ 'as'   => 'master.section.dataTable',
     'uses' => 'Sectionontroller@getDatatable']);

Route::get('master/section/add', 'SectionController@create');
Route::post('master/section/add', 'SectionController@store');
Route::get('master/section/edit/{slug}', 'SectionController@edit');
Route::patch('master/section/edit/{slug}', 'SectionController@update');
Route::delete('master/section/delete/{slug}', 'SectionController@delete');
...
Route::get('children/analysis/{slug}', 'ParentsController@childdash');
...
Route::get('messages/getmsg/{id}', 'MessagesController@getmsg');
Route::post('messages/update/{id}', 'MessagesController@update');
...
Route::get('user', [ 'as'   => 'inst.dataTable',
    'uses' => 'InstitutionController@getDatatable']);

Route::get('/institution/{inst_name?}/student','InstitutionController@student');
Route::get('/institution/{inst_name?}/teacher','InstitutionController@teacher');
...
Route::get('sebmission/quizzes/{slug}','TeacherController@subdetailbystd');
