   ...
   public function index()
    ...
    public function getDatatable()
    {
      ...
      if (checkRole(['owner'])) {
        ...
        ->select(['title', 'image','name','users.slug as slug','subject','role_id','description','feedbacks.slug as fdslug', 'feedbacks.id', 'feedbacks.updated_at', 'read_status'])
        ...
        ->addColumn('action', function ($records) {
          ...
          $link_data = '<div class="dropdown more">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                           <li><a href="'.URL_FEEDBACK_VIEW.$records->fdslug.'"><i class="fa fa-eye"></i>'.getPhrase("view").'</a></li>';


                    if ($records->read_status==0)       
                    $link_data .= '<li><a href="'.URL_FEEDBACK_STATUS.$records->fdslug.'"><i class="fa fa-check"></i>'.getPhrase("approve").'</a></li>';
                    elseif ($records->read_status==1)       
                    $link_data .= '<li><a href="'.URL_FEEDBACK_STATUS.$records->fdslug.'"><i class="fa fa-close"></i>'.getPhrase("disapprove").'</a></li>';
                           
                            
                    $temp = '';
                    if(checkRole(getUserGrade(1))) {
                    $temp .= ' <li><a href="javascript:void(0);" onclick="deleteRecord(\''.$records->fdslug.'\');"><i class="fa fa-trash"></i>'. getPhrase("delete").'</a></li>';
                      }
        ...
        {
        	return '<a href="'.URL_FEEDBACK_VIEW.$records->fdslug.'">'.$records->title.'</a>';
        })
