...
//MASTER MODULE
define('URL_DEPARTMENT_LIST', PREFIX.'master/department/list');
define('URL_DEPARTMENT_ADD', PREFIX.'master/department/add');
define('URL_DEPARTMENT_EDIT', PREFIX.'master/department/edit');
//define('URL_LANGUAGES_UPDATE_STRINGS', PREFIX.'languages/update-strings/');
define('URL_DEPARTMENT_DELETE', PREFIX.'master/department/delete/');
define('URL_DEPARTMENT_GETLIST', PREFIX.'master/department/getList/');
//define('URL_LANGUAGES_MAKE_DEFAULT', PREFIX.'languages/make-default/');

define('URL_SECTION_LIST', PREFIX.'master/section/list');
define('URL_SECTION_ADD', PREFIX.'master/section/add');
define('URL_SECTION_EDIT', PREFIX.'master/section/edit');
//define('URL_LANGUAGES_UPDATE_STRINGS', PREFIX.'languages/update-strings/');
define('URL_SECTION_DELETE', PREFIX.'master/section/delete/');
define('URL_SECTION_GETLIST', PREFIX.'master/section/getList/');
//define('URL_LANGUAGES_MAKE_DEFAULT', PREFIX.'languages/make-default/');
...
define('URL_FAQS_all', PREFIX.'faqs/all');
...
define('URL_SUBMISSION_QUIZE', PREFIX.'sebmission/quizzes');
